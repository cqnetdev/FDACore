    ...
    static class Program
    {
        ...
        internal class FDAManagerContext : ApplicationContext
        {
            ...
            public FDAManagerContext(string[] args)
            {
                ...
                notifyIcon.ContextMenuStrip.Items.Add(titleItem);
                notifyIcon.ContextMenuStrip.Items.Add(new ToolStripSeparator());
                notifyIcon.ContextMenuStrip.Items.Add(openGuiMenuItem);
                notifyIcon.ContextMenuStrip.Items.Add(new ToolStripSeparator());
            ...
            Retry:
                ...
                try
                {
                    ...
                    string EncrMQTTPass = GetSetting("MQTT");
                    string pass = Encryption.DecryptString(EncrMQTTPass, "MC9fSLAfwkrHCx0j6LG4");
                    MQTT = new MqttClient(MQTTServer_IP);
            ...
            private static void UpdateFDAStatusIcon(string FDAstatus)
            {
                ...
                switch (FDAstatus)
                {
                    // starting
                    case "Starting":
                        notifyIcon.Icon = GetIcon("ManagerYellow"); // Properties.Resources.ManagerYellow;
                        notifyIcon.Text = "FDA Starting";
                        break;
                    // running
                    case "Normal":
                        notifyIcon.Icon = GetIcon("ManagerGreen"); // Properties.Resources.ManagerGreen;
            ...
            {
                string fullName = "FDAManager.Resources." + iconName + ".ico";
