...
namespace FDA
{
    public enum ScheduleType {Realtime,Hourly,Daily,Monthly,Specific};
    ...
    public abstract class FDAScheduler: IDisposable
    {
        ...
        {
            TimerElapsed?.Invoke(this, new TimerEventArgs(ID, Type, RequestGroupList));
        }
